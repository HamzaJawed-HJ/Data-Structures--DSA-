public class CircularQueueArray
{
    ...
    public void PrintCircularQueueArray() throws Exception
    {
       if(front<=rear)
       {
           for(int i=front; i<=rear; i++)  //If Linear
           {

               System.out.println("Linear: "+items[i]);
           }
       }
       else
       {
           ...
           {
               System.out.println("Circular: "+items[i]);
           }
           for(int i=0; i<=rear; i++)   //If Circular
           {
               System.out.println("Circular: "+items[i]);
           }
       }
